...
%
%2) In my approach, Essence Reflection meetings happen weekly during a project. During project initiation, there might not be any iterations and its helpful to conduct Essence Reflection meetings. On agile projects iterations can range from one week to one month. Frequent, weekly meetings are helpful for a team.
%
...
%My field study of graduate software engineering teams reveals the Essence kernel provides value to teams during project inception but does not reflect incremental progress achieved during construction on iterative projects.
...
%for the Essence kernel  for iterative software development would enable teams to find value from Essence during the construction phase of a project. Given the differences between traditional and iterative software development, possibly two essence kernels would emerge tailored to the unique circumstances of traditional and agile software development.
